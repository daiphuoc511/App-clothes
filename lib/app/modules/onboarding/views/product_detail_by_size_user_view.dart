...
class ProductDetailBySizeUserView extends GetView<LoginController> {
  ...
  ProductDetailBySizeUserView({required this.productId});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: buildProductBySizeUserDetailPage(context),
      bottomSheet: Row(
