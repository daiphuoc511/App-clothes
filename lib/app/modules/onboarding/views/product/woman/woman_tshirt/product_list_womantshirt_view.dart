...
import 'package:clothes_app/app/modules/onboarding/views/product/woman/woman_tshirt/product_detail_womantshirt_view.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class ProductListWomanTshirtView
        ...
        children: <Widget>[
          ...
          Obx(
            () => GridView.builder(
              ...
              itemCount: _productListWomanTshirtController.productList.length,
              itemBuilder: (context, index) {
                return Container(
                  ...
                  child: InkWell(
                    ...
                    child: Column(
                      children: [
                        Container(
                          ...
                          child: Image.asset(
                            _productListWomanTshirtController
                    ...
                    onTap: () {
                      Get.to(ProductDetailListWomanTshirtView(
                          productId: _productListWomanTshirtController
