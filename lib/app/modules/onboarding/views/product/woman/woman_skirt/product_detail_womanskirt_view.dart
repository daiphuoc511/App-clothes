...
class ProductDetailListWomanSkirtView
  ...
  ProductDetailListWomanSkirtView({Key? key, required this.productId})
      : super(key: key);
  ...
  buildProductDetailPage(BuildContext context) {
    Size screenSize = MediaQuery.of(context).size;
    var product = _productListWomanSkirtController.getProductById(productId);
    return Container(
      padding: const EdgeInsets.all(0),
      child: ListView(
        children: [
