...
class ProductDetailListWomanDressView
  ...
  ProductDetailListWomanDressView({Key? key, required this.productId})
      : super(key: key);
  ...
  buildProductDetailPage(BuildContext context) {
    Size screenSize = MediaQuery.of(context).size;
    var product = _productListWomanDressController.getProductById(productId);
    return Container(
      padding: const EdgeInsets.all(0),
      child: ListView(
        children: [
