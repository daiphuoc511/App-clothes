...
class ProductDetailListManTshirtView
    extends GetView<ProductListManTshirtController> {
  final ProductListManTshirtController _productListManTshirtController =
      Get.put(ProductListManTshirtController());
  final int productId;

  ProductDetailListManTshirtView({Key? key, required this.productId})
      : super(key: key);
  ...
  buildProductDetailPage(BuildContext context) {
    Size screenSize = MediaQuery.of(context).size;
    var product = _productListManTshirtController.getProductById(productId);
    return Container(
      padding: const EdgeInsets.all(0),
      child: ListView(
        children: [
