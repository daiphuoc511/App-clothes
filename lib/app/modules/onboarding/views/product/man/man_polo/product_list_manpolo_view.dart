...
import 'package:clothes_app/app/modules/onboarding/views/product/man/man_polo/product_detail_manpolo_view.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class ProductListManPoloView extends GetView<ProductListManPoloController> {
        ...
        children: <Widget>[
          ...
          Obx(
            () => GridView.builder(
              ...
              itemCount: _productListManPoloController.productList.length,
                  ...
                  child: InkWell(
                    ...
                    child: Column(
                      children: [
                        ...
                        const SizedBox(height: 5),
                        Text(
                          _productListManPoloController.productList[index].price
                              .toString(),
                          style: const TextStyle(
                    ...
                    onTap: () {
                      Get.to(ProductDetailListManPoloView(
                          productId: _productListManPoloController
