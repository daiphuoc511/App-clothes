...
class ProductDetailListManKakiView
    extends GetView<ProductListManKakiController> {
  final ProductListManKakiController _productListManKakiController =
      Get.put(ProductListManKakiController());
  final int productId;

  ProductDetailListManKakiView({Key? key, required this.productId})
      : super(key: key);
  ...
  buildProductDetailPage(BuildContext context) {
    Size screenSize = MediaQuery.of(context).size;
    var product = _productListManKakiController.getProductById(productId);
    return Container(
      padding: const EdgeInsets.all(0),
      child: ListView(
        children: [
