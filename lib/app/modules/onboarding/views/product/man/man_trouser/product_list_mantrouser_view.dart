...
import 'package:clothes_app/app/modules/onboarding/views/product/man/man_trouser/product_detail_mantrouser_view.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class ProductListManTrouserView
        ...
        children: <Widget>[
          ...
          Obx(
            () => GridView.builder(
              ...
              itemCount: _productListManTrouserController.productList.length,
              itemBuilder: (context, index) {
                return Container(
                  ...
                  child: InkWell(
                    ...
                    child: Column(
                      children: [
                        Container(
                          ...
                          child: Image.asset(
                            _productListManTrouserController
                    ...
                    onTap: () {
                      Get.to(ProductDetailListManTrouserView(
                          productId: _productListManTrouserController
