...
class ProductListManController extends GetxController {
  static ProductListManController get to => Get.find();
  ...
  Future<void> fetchProductByColor() async {
    http.Response response =
        await http.get(Uri.parse('${RemoteConfig.config['PRODUCT_MAN']}'));
