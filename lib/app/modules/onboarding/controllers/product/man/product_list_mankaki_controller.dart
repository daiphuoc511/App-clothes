...
class ProductListManKakiController extends GetxController {
  static ProductListManKakiController get to => Get.find();
  ...
  Future<void> fetchProductByColor() async {
    http.Response response =
        await http.get(Uri.parse('${RemoteConfig.config['PRODUCT_MAN_KAKI']}'));
