...
class ProductListWomanTshirtController extends GetxController {
  static ProductListWomanTshirtController get to => Get.find();
  ...
  Future<void> fetchProductByColor() async {
    http.Response response = await http.get(
        Uri.parse('http://192.168.1.1:8080/api/user/product_woman_tshirt'));
